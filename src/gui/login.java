...
import static domain.General.cargarParametrosIniciales;
...
public class login extends javax.swing.JDialog {
    ...
    private void acceder() {
       ...
       // ManejadorBD  manejadorBD = conectarBD();  
        
        manejadorBD.usuario = usuario.getText();
        manejadorBD.palabraClave = contraseña.getText();
                  
        conectarBD();
                         
        if ( !manejadorBD.errorSQL.equals("") ) {
            ...
            principal.setTitle("EON "+sucursal.datos_fiscales.getNombre_comercial());
