...
public class ComandaCaptura extends InternalFrameAbstracto {
    ...
    private void initComponents() {
        ...
        boton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/images/trash_100px.png"))); // NOI18N
        boton1.setBorderPainted(false);
        boton1.setContentAreaFilled(false);
        boton1.setMargin(new java.awt.Insets(0, 0, 0, 0));
        boton1.setOpaque(false);
        boton1.setPreferredSize(new java.awt.Dimension(50, 50));
